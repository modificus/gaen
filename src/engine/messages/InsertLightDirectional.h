//------------------------------------------------------------------------------
// InsertLightDirectional.h - Autogenerated message class for InsertLightDirectional
//
...
private:
    InsertLightDirectionalR(const InsertLightDirectionalR &)              = delete;
    InsertLightDirectionalR(const InsertLightDirectionalR &&)             = delete;
    InsertLightDirectionalR & operator=(const InsertLightDirectionalR &)  = delete;
    InsertLightDirectionalR & operator=(const InsertLightDirectionalR &&) = delete;
...
private:
    InsertLightDirectionalQW(const InsertLightDirectionalQW &)              = delete;
    InsertLightDirectionalQW(const InsertLightDirectionalQW &&)             = delete;
    InsertLightDirectionalQW & operator=(const InsertLightDirectionalQW &)  = delete;
    InsertLightDirectionalQW & operator=(const InsertLightDirectionalQW &&) = delete;
};
...
private:
    InsertLightDirectionalBW(const InsertLightDirectionalBW &)              = delete;
    InsertLightDirectionalBW(const InsertLightDirectionalBW &&)             = delete;
    InsertLightDirectionalBW & operator=(const InsertLightDirectionalBW &)  = delete;
    InsertLightDirectionalBW & operator=(const InsertLightDirectionalBW &&) = delete;
