...
//   distribution.
//------------------------------------------------------------------------------
#ifndef GAEN_RENDERERGL_SHADERS_PRESENT_TEXTURE_H
#define GAEN_RENDERERGL_SHADERS_PRESENT_TEXTURE_H
...
class present_texture : Shader
{
public:
    static Shader * construct();

private:
    present_texture() : Shader(0x45b35f98 /* HASH::present_texture */) {}
...
}; // class present_texture

} // namespace shaders
} // namespace gaen
#endif // #ifdef GAEN_RENDERERGL_SHADERS_PRESENT_TEXTURE_H
