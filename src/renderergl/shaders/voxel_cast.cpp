...
static const char * kShaderCode_shc =
    ...
    "VoxelRef unpack_voxel_ref(uint r, uint g)\n"
    "{\n"
    "/*    pix.r = ((pix.r & 0x000000ff) << 24 |\n"
    "             (pix.r & 0x0000ff00) <<  8 |\n"
    "             (pix.r & 0x00ff0000) >>  8 |\n"
    "             (pix.r & 0xff000000) >> 24);\n"
    "\n"
    "    pix.g = ((pix.g & 0x000000ff) << 24 |\n"
    "             (pix.g & 0x0000ff00) <<  8 |\n"
    "             (pix.g & 0x00ff0000) >>  8 |\n"
    "             (pix.g & 0xff000000) >> 24);\n"
    "*/  \n"
    "    VoxelRef ref;\n"
    "\n"
    "    ref.type = r & 0x3; // 2 bits\n"
    "    ref.material = (r & 0xffc) >> 2; // 10 bits\n"
    "    \n"
    "    ref.imageIdx = (r & 0x7000) >> 12; // 3 bits\n"
    "    ref.voxelIdx = ((g & 0x3f) << 17) | ((r & 0xffff8000) >> 15); // 23 bits (17 in .r, 6 in .g)\n"
    "\n"
    "//    if (r != 0)\n"
    "//        ref.voxelIdx = 50;\n"
    "\n"
    "    ref.filledNeighbors = (g & 0xffffffc0) >> 6; // 26 bits\n"
    "\n"
    "    return ref;\n"
    "}\n"
    "\n"
    ...
    "\n"
    "    root.children = unpack_voxel_ref(pix7.r, pix7.g);\n"
    "\n"
    "    return root;\n"
    "}\n"
    "\n"
