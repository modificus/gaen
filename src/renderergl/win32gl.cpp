//------------------------------------------------------------------------------
// win32gl.cpp - Win32 opengl function pointers
//
...
void init_win32gl()
{
    ...
    glCullFace = (PFNGLCULLFACEPROC)GetProcAddress(hOpenGL32, "glCullFace");
    glFrontFace = (PFNGLFRONTFACEPROC)GetProcAddress(hOpenGL32, "glFrontFace");
    glHint = (PFNGLHINTPROC)GetProcAddress(hOpenGL32, "glHint");
    glLineWidth = (PFNGLLINEWIDTHPROC)GetProcAddress(hOpenGL32, "glLineWidth");
    glPointSize = (PFNGLPOINTSIZEPROC)GetProcAddress(hOpenGL32, "glPointSize");
    glPolygonMode = (PFNGLPOLYGONMODEPROC)GetProcAddress(hOpenGL32, "glPolygonMode");
    glScissor = (PFNGLSCISSORPROC)GetProcAddress(hOpenGL32, "glScissor");
    glTexParameterf = (PFNGLTEXPARAMETERFPROC)GetProcAddress(hOpenGL32, "glTexParameterf");
    glTexParameterfv = (PFNGLTEXPARAMETERFVPROC)GetProcAddress(hOpenGL32, "glTexParameterfv");
    glTexParameteri = (PFNGLTEXPARAMETERIPROC)GetProcAddress(hOpenGL32, "glTexParameteri");
    glTexParameteriv = (PFNGLTEXPARAMETERIVPROC)GetProcAddress(hOpenGL32, "glTexParameteriv");
    glTexImage1D = (PFNGLTEXIMAGE1DPROC)GetProcAddress(hOpenGL32, "glTexImage1D");
    glTexImage2D = (PFNGLTEXIMAGE2DPROC)GetProcAddress(hOpenGL32, "glTexImage2D");
    glDrawBuffer = (PFNGLDRAWBUFFERPROC)GetProcAddress(hOpenGL32, "glDrawBuffer");
    ...
    glClearStencil = (PFNGLCLEARSTENCILPROC)GetProcAddress(hOpenGL32, "glClearStencil");
    glClearDepth = (PFNGLCLEARDEPTHPROC)GetProcAddress(hOpenGL32, "glClearDepth");
    glStencilMask = (PFNGLSTENCILMASKPROC)GetProcAddress(hOpenGL32, "glStencilMask");
    glColorMask = (PFNGLCOLORMASKPROC)GetProcAddress(hOpenGL32, "glColorMask");
    glDepthMask = (PFNGLDEPTHMASKPROC)GetProcAddress(hOpenGL32, "glDepthMask");
    glDisable = (PFNGLDISABLEPROC)GetProcAddress(hOpenGL32, "glDisable");
    glEnable = (PFNGLENABLEPROC)GetProcAddress(hOpenGL32, "glEnable");
    glFinish = (PFNGLFINISHPROC)GetProcAddress(hOpenGL32, "glFinish");
    glFlush = (PFNGLFLUSHPROC)GetProcAddress(hOpenGL32, "glFlush");
    glBlendFunc = (PFNGLBLENDFUNCPROC)GetProcAddress(hOpenGL32, "glBlendFunc");
    glLogicOp = (PFNGLLOGICOPPROC)GetProcAddress(hOpenGL32, "glLogicOp");
    glStencilFunc = (PFNGLSTENCILFUNCPROC)GetProcAddress(hOpenGL32, "glStencilFunc");
    glStencilOp = (PFNGLSTENCILOPPROC)GetProcAddress(hOpenGL32, "glStencilOp");
    glDepthFunc = (PFNGLDEPTHFUNCPROC)GetProcAddress(hOpenGL32, "glDepthFunc");
    glPixelStoref = (PFNGLPIXELSTOREFPROC)GetProcAddress(hOpenGL32, "glPixelStoref");
    glPixelStorei = (PFNGLPIXELSTOREIPROC)GetProcAddress(hOpenGL32, "glPixelStorei");
    glReadBuffer = (PFNGLREADBUFFERPROC)GetProcAddress(hOpenGL32, "glReadBuffer");
    glReadPixels = (PFNGLREADPIXELSPROC)GetProcAddress(hOpenGL32, "glReadPixels");
    glGetBooleanv = (PFNGLGETBOOLEANVPROC)GetProcAddress(hOpenGL32, "glGetBooleanv");
    glGetDoublev = (PFNGLGETDOUBLEVPROC)GetProcAddress(hOpenGL32, "glGetDoublev");
    glGetError = (PFNGLGETERRORPROC)GetProcAddress(hOpenGL32, "glGetError");
    glGetFloatv = (PFNGLGETFLOATVPROC)GetProcAddress(hOpenGL32, "glGetFloatv");
    glGetIntegerv = (PFNGLGETINTEGERVPROC)GetProcAddress(hOpenGL32, "glGetIntegerv");
    glGetString = (PFNGLGETSTRINGPROC)GetProcAddress(hOpenGL32, "glGetString");
    glGetTexImage = (PFNGLGETTEXIMAGEPROC)GetProcAddress(hOpenGL32, "glGetTexImage");
    glGetTexParameterfv = (PFNGLGETTEXPARAMETERFVPROC)GetProcAddress(hOpenGL32, "glGetTexParameterfv");
    glGetTexParameteriv = (PFNGLGETTEXPARAMETERIVPROC)GetProcAddress(hOpenGL32, "glGetTexParameteriv");
    glGetTexLevelParameterfv = (PFNGLGETTEXLEVELPARAMETERFVPROC)GetProcAddress(hOpenGL32, "glGetTexLevelParameterfv");
    glGetTexLevelParameteriv = (PFNGLGETTEXLEVELPARAMETERIVPROC)GetProcAddress(hOpenGL32, "glGetTexLevelParameteriv");
    glIsEnabled = (PFNGLISENABLEDPROC)GetProcAddress(hOpenGL32, "glIsEnabled");
    glDepthRange = (PFNGLDEPTHRANGEPROC)GetProcAddress(hOpenGL32, "glDepthRange");
    glViewport = (PFNGLVIEWPORTPROC)GetProcAddress(hOpenGL32, "glViewport");
    glDrawArrays = (PFNGLDRAWARRAYSPROC)GetProcAddress(hOpenGL32, "glDrawArrays");
    glDrawElements = (PFNGLDRAWELEMENTSPROC)GetProcAddress(hOpenGL32, "glDrawElements");
    glGetPointerv = (PFNGLGETPOINTERVPROC)GetProcAddress(hOpenGL32, "glGetPointerv");
    glPolygonOffset = (PFNGLPOLYGONOFFSETPROC)GetProcAddress(hOpenGL32, "glPolygonOffset");
    glCopyTexImage1D = (PFNGLCOPYTEXIMAGE1DPROC)GetProcAddress(hOpenGL32, "glCopyTexImage1D");
    glCopyTexImage2D = (PFNGLCOPYTEXIMAGE2DPROC)GetProcAddress(hOpenGL32, "glCopyTexImage2D");
    glCopyTexSubImage1D = (PFNGLCOPYTEXSUBIMAGE1DPROC)GetProcAddress(hOpenGL32, "glCopyTexSubImage1D");
    glCopyTexSubImage2D = (PFNGLCOPYTEXSUBIMAGE2DPROC)GetProcAddress(hOpenGL32, "glCopyTexSubImage2D");
    glTexSubImage1D = (PFNGLTEXSUBIMAGE1DPROC)GetProcAddress(hOpenGL32, "glTexSubImage1D");
    glTexSubImage2D = (PFNGLTEXSUBIMAGE2DPROC)GetProcAddress(hOpenGL32, "glTexSubImage2D");
    glBindTexture = (PFNGLBINDTEXTUREPROC)GetProcAddress(hOpenGL32, "glBindTexture");
    glDeleteTextures = (PFNGLDELETETEXTURESPROC)GetProcAddress(hOpenGL32, "glDeleteTextures");
    glGenTextures = (PFNGLGENTEXTURESPROC)GetProcAddress(hOpenGL32, "glGenTextures");
    glIsTexture = (PFNGLISTEXTUREPROC)GetProcAddress(hOpenGL32, "glIsTexture");
